...
class HomeController extends Controller
{
        ...
        return Inertia::render('Dashboard/Index', [
            ...
            'options' => [
                ...
                'countries' => Models\Country::where('active', 1)
                    ...
                    ->values(),
                'orderTypes' => [
                    ['name' => __('Status'), 'value' => 'status'],
                    ['name' => __('Payment Status'), 'value' => 'payment_status']
                ],
                ...
                'orderPaymentStatuses' => collect(Models\Order::getPaymentStatusesMap())
                    ...
                    ->toArray(),
                'xAxis' => [
                    ['name' => __('Amount'), 'value' => 'amount'],
                    ['name' => __('Quantity'), 'value' => 'quantity']
                ],
                'yAxis' => [
                    ['name' => __('Brands'), 'value' => 'brand'],
                    ['name' => __('Categories'), 'value' => 'categories'],
                    ['name' => __('Attributes'), 'value' => 'attributes']
                ],
                'yAxisKeys' => Models\ProductAttribute::pluck('key')
                    ...
                    ->toArray(),
                'horizontalCharts' => [
                    ['name' => __('Simple Horizontal Bar'), 'value' => 'exx-simple-horizontal-bar-card'],
                    ['name' => __('Simple Line'), 'value' => 'exx-simple-line-card']
                ],
                'pieCharts' => [
                    ['name' => __('Simple Pie'), 'value' => 'exx-simple-pie-card'],
                    ['name' => __('Pie with Variable Radius'), 'value' => 'exx-pie-with-variable-radius-card'],
                    ['name' => __('Simple Donut'), 'value' => 'exx-simple-donut-card'],
                ],
            ]
        ]);
    }
    ...
    public function updateLang(Request $request): void
    {
        Cache::put("sellexx.language:{$request->user()->id}", $request->route('value'));
