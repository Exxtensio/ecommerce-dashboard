...
trait Resolvable
{
    ...
    public function resolvedForTranslations($translations): void
    {
        $current = $translations->where('column', $this->attribute);
        $this->translations = $current->pluck('value', 'locale')->toArray();
    }
