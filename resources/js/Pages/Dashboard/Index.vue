    ...
    <div class="dashboard p-6">
        <div class="my-6 flex justify-between">
            <div class="flex flex-col">
                ...
                <p v-if="canViewAny" class="text-gray-400 dark:text-gray-500">Here's what's happening with your store today.</p>
            </div>
            <div v-if="canViewAny">
                <VueDatePicker
                    range
        ...
        <div v-if="canViewAny" class="grid grid-cols-6 gap-4 max-[1800px]:grid-cols-3 max-[1080px]:grid-cols-2 max-[580px]:grid-cols-1 mb-4">
            <div
                class="item type-total"
                v-for="card in totalCards"
            >
                <exx-total-card-dropdown
                    v-if="!card.id && canCreate"
                    @saveCard="saveCard"
                    :type="card.type"
        ...
        <div v-if="canViewAny" class="grid grid-cols-3 gap-4 max-[1800px]:grid-cols-1 mb-4">
            <div
        ...
        <div v-if="canViewAny" class="grid grid-cols-3 gap-4 max-[1800px]:grid-cols-1">
            <div
