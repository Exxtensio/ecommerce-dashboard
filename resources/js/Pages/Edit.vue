                ...
                <div class="mb-6 mt-10 flex items-center justify-between">
                    <div class="text-white space-y-2">
                        <div class="flex items-end space-x-4">
                            ...
                            <div v-if="can(getId, 'canPreview')">
                                <fwb-button size="xs" color="light" class="btn-light" :href="showLink">Preview</fwb-button>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="flex items-center justify-end gap-x-2">
                            <fwb-button color="light" class="btn-light" @click="revert">Revert changes</fwb-button>
                            <fwb-button color="light" class="btn-light" @click="update(false)">Save & Continue Editing</fwb-button>
                            <fwb-button color="default" class="btn-success" @click="update(true)">Save</fwb-button>
                        </div>
                    </div>
                </div>
            ...
            await axios.post(this.getResourceUrl(this.getId), this.dataToUpdate)
                .then(response => {
                    this.emitter.emit('notify', {
                        type: 'success',
                        message: `${this.singularLabel} updated successfully`
                    })
