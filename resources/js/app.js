...
import NotificationButton from '@/Shared/Buttons/NotificationButton.vue'
...
createInertiaApp({
    ...
    setup({el, App, props, plugin}) {
        ...
        app.component('exx-notification-button', NotificationButton)
        ...
        config.$globalStore.verifyKey(
            config.$page.props.appKey,
            config.$page.props.appSecret,
            config.$page.props.xApiKey
        )

        localStorage.setItem('sellexx_version', config.$page.props.releases.currentVersion)
        localStorage.setItem('sellexx_releases', JSON.stringify(config.$page.props.releases.uninstalledList))
    },
})
