<template>
    <div :class="{'required': isRequired}" class="readonly">
        ...
        <div v-if="Object.keys(list).length" class="grid grid-cols-4 gap-4 border theme-brand-border-color rounded-md p-4">
            <div
        ...
        <p v-else class="text-sm py-2">There is no permissions</p>
