...
export default {
    ...
    methods: {
        ...
        cacheRequest(name, value) {
            this.$axios.post(this.getResourceUrl('c'), {
                key: name,
                value: value,
            })
        },
        ...
        deleteResource(array) {
            this.$axios.post(this.getResourceUrl('action/delete'), {array: array})
                .then(response => {
        ...
        forceResource(array) {
            this.$axios.post(this.getResourceUrl('action/force'), {array: array})
                .then(response => {
                    this.actionWhenResponse()
                }).catch(errors => {
                this.emitter.emit('load', false)
        ...
        restoreResource(array) {
            this.$axios.post(this.getResourceUrl('action/restore'), {array: array})
                .then(response => {
                    this.actionWhenResponse()
                }).catch(errors => {
                this.emitter.emit('load', false)
